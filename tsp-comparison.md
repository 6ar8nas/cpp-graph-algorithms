| Graph | Complete graph gen. duration (s) | Double tree duration (s) | Nearest neighbor duration (s) | Random insertion duration (s) | Double tree path weight | Nearest neighbor path weight | Random insertion path weight |
|------------------------|-------------|-------------|-------------|-------------|--------|--------|--------|
